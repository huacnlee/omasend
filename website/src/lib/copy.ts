export const copy = {
  en: {
    ...
    intro: 'The things on your screen, on your other device. A native LocalSend client, made with GPUI Omarchy.',
    ...
    facts: [
      ...
      ['Built for Omarchy', 'Native Rust and GPUI, with gpui-omarchy components that follow your desktop theme. English and 简体中文 included.'],
  ...
  'zh-CN': {
    ...
    intro: '把屏幕上的内容，送到另一台设备。使用 GPUI Omarchy 构建的原生 LocalSend 客户端。',
    ...
    facts: [
      ...
      ['为 Omarchy 打造', '原生 Rust 与 GPUI，使用跟随桌面主题的 gpui-omarchy 组件。支持 English 和简体中文。'],
