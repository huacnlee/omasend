use super::Home;
use gpui_omarchy::gpui::{AnyElement, Context, Window, div, prelude::*};
use gpui_omarchy::{ActiveTheme, ButtonVariant, button, dialog, dialog_popup, dialog_title};
                ...
                dialog_popup(cx)
                    .child(
                        div()
                            ...
                            .items_center()
                            .gap_3()
                            .child(super::motion::logo(32., theme.accent))
